                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Marketing', style: TextStyle(fontSize: 30)),
                        VerticalLineWidget(height: 200),
                        _buildTitle('Foundation of Marketing'),
                        VerticalLineWidget(height: 200),
                        _buildTitle('Digital Marketing'),
                        VerticalLineWidget(height: 200),
                        _buildTitle('Advanced Marketing Strategies'),
                        
                      ],
                    ),
                  ),
                  Positioned(
                    top: 272, // Adjust position as needed
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          children: [
                            _buildTopicbigger('Introduction to Marketing'),
                            _buildTopicbigger('Market Research'),
                            _buildTopicbigger('Consumer Behavior'),
                        ...
                        HorizontalPointsWidget(
                          width: 300,
                          pointPositions: [for (var i = 20; i <= 260; i += 10) i.toDouble()],
                        ),
                      ],
                    ),
                  ),
                  Positioned(
                    top: 545, // Adjust position as needed
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            _buildTopicbigger('SEO(Search Engine Optimization)'),
                            _buildTopicbigger('Content Marketing'),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            _buildTopicbigger('Brand Management'),
                            _buildTopicbigger('Strategic Marketing'),
